  ...
  return (
    ...
    <div className="min-h-screen w-full flex flex-col items-center justify-center bg-black text-white relative overflow-hidden p-4">
      ...
      <div className="relative z-10 max-w-4xl w-full text-center space-y-8">
        {/* Error message */}
        <h1 className="text-4xl font-bold mb-4"> <span className="text-[#ffae00]">404</span> - Page Not Found</h1>
        ...
        <div className="animate-float mb-8">
          <img
            src={Images.error}
            alt="KAWS Figurines"
            className="w-full max-w-2xl mx-auto object-cover rounded-lg mt-5"
          />
        </div>
      </div>
