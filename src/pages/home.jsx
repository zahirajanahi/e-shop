      ...
      <section className="bg-[#251d1d] text-white py-12" id="contact">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="flex justify-center">
            <form className="w-full max-w-lg bg-[#f3e7d9] p-8 rounded-lg shadow-lg">
              <div className="grid grid-cols-1 gap-6 mb-6">
                ...
                <div>
                  ...
                  <textarea id="message" name="message" rows="4" className="w-full border border-gray-300 p-2 rounded-md focus:outline-none focus:border-blue-500 bg-transparent" required></textarea>
                </div>
              </div>
