...
const Landing = () => {
    ...
    return (
        ...
        <div className='bg-[#000]'>
            ...
            <div className="relative h-[100vh] overflow-hidden">
                ...
                <motion.div 
                    ...
                    className="absolute left-16 bottom-16 text-white max-w-md"
                >
                    ...
                    <motion.button 
                        ...
                        whileTap={{ scale: 0.95 }}
                        className="bg-transparent border border-white rounded-3xl text-white px-6 py-3"
                        onClick={handleClick} 
                    >
                        Shop Now
                    </motion.button>
        ...
        <motion.div 
            ...
            whileInView="animate"
            viewport={{ once: true }}
            className='bg-gradient-to-r from-black via-zinc-950 to-gray-950 flex space-x-64'
        > 
            <motion.img 
                src={imageSrc} 
                animate={{ y: [-20, 0, -20] }}
            ...
            <motion.button 
                whileHover={{ scale: 1.05 }}
                className='font-semibold text-lg text-white flex space-x-2 group'
                onClick={handleScrollToCollections} // Add onClick event
            >
                ...
                <motion.div 
                    ...
                    whileInView="animate"
                    viewport={{ once: true }}
                    className='text-[2.10rem] text-[#fff] font-bold flex flex-col mt-36 mb-5'
                >
        ...
        <div className='bg-white mt-12 grid-section' ref={gridSectionRef}>
            <motion.div 
        ...
        <motion.div 
            ...
            className='bg-gradient-to-r from-black via-zinc-950 to-gray-950 w-[85vw] mx-auto h-[40vh] mt-5 rounded-2xl flex items-center justify-between'
        >
            <div>
                <motion.h1 
                    variants={fadeInUp}
                    initial="initial"
                    whileInView="animate"
                    className='text-3xl text-white pb-20 ms-5'
                >
                ...
                <motion.a
                    href="/shop"
                    whileHover={{ scale: 1.05 }}
                    className='font-semibold ms-10 text-white flex space-x-2 group'
                >
            ...
            <motion.div
                ...
                transition={{ type: "spring", stiffness: 300 }}
            >
                <img src={Images.shopn} className='h-[37vh] me-10 rounded-2xl' alt="" />
            </motion.div>
        </motion.div>
